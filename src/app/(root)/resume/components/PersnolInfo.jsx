...
const socialsLinks = [
  { name: 'Github', link: 'https://github.com/Daya3611', icon: <Github className="w-5 h-5" /> },
  { name: 'LinkedIn', link: 'https://www.linkedin.com/in/dayanandgawade/', icon: <Linkedin className="w-5 h-5" /> },
  { name: 'Twitter', link: 'https://twitter.com/_daya3611', icon: <Twitter className="w-5 h-5" /> },
  { name: 'Instagram', link: 'https://instagram.com/_daya3611', icon: <Instagram className="w-5 h-5" /> },
  ...
  return (
    <section className="relative py-16 px-4 md:px-10 lg:px-24 overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center space-y-6">
        ...
        <h1 className="text-4xl font-bold text-neutral-800 dark:text-white">Dayanand Gawade</h1>
        ...
        {/* <div className="mt-10 space-y-2 text-md font-semibold text-gray-600 dark:text-gray-400">
          ...
          <p>Email: hi@dayanandgawade.in</p>
          <p>Phone: NA</p>
        </div> */}

        <div className="mt-8">
          <Link href="/Dayanand Gawade Resume.pdf" download>
