            ...
            <div className="flex items-center gap-3">
              ...
              >
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-6"  onClick={()=> window.location.href = 'https://discord.com/users/1344659921358164052' }>
