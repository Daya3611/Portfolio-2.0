          ...
          <div className="relative bg-gradient-to-r from-gray-900 via-gray-800 to-black rounded-2xl md:rounded-3xl p-8 md:p-16 text-white overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center">
                <button className="group relative inline-flex items-center justify-center gap-2 md:gap-3 px-6 md:px-8 py-3 md:py-4 bg-white text-gray-900 rounded-xl md:rounded-2xl font-bold text-base md:text-lg overflow-hidden transition-all hover:scale-105" onClick={() => window.location.href = 'https://github.com/Daya3611'}>
